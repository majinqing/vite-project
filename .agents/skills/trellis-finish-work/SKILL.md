...
```bat
.\.trellis\python.cmd .\.trellis\scripts\get_context.py --mode record
```
...
```bat
.\.trellis\python.cmd .\.trellis\scripts\task.py archive <task-name>
```
...
```bat
.\.trellis\python.cmd .\.trellis\scripts\add_session.py ^
  --title "Session Title" ^
  --commit "hash1,hash2" ^
