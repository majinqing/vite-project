...
```bat
.\.trellis\python.cmd .\.trellis\scripts\init_developer.py <your-name>
```
...
```bat
.\.trellis\python.cmd .\.trellis\scripts\get_context.py --mode packages
```
...
```bat
# Task lifecycle
.\.trellis\python.cmd .\.trellis\scripts\task.py create "<title>" [--slug <name>] [--parent <dir>]
.\.trellis\python.cmd .\.trellis\scripts\task.py start <name>
.\.trellis\python.cmd .\.trellis\scripts\task.py current --source
.\.trellis\python.cmd .\.trellis\scripts\task.py finish
.\.trellis\python.cmd .\.trellis\scripts\task.py archive <name>
.\.trellis\python.cmd .\.trellis\scripts\task.py list [--mine] [--status <s>]
.\.trellis\python.cmd .\.trellis\scripts\task.py list-archive

# Code-spec context (injected into implement/check agents via JSONL).
# `implement.jsonl` / `check.jsonl` are seeded on `task create` for sub-agent-capable
# platforms; the AI curates real spec + research entries during Phase 1.3.
.\.trellis\python.cmd .\.trellis\scripts\task.py add-context <name> <action> <file> <reason>
.\.trellis\python.cmd .\.trellis\scripts\task.py list-context <name> [action]
.\.trellis\python.cmd .\.trellis\scripts\task.py validate <name>

# Task metadata
.\.trellis\python.cmd .\.trellis\scripts\task.py set-branch <name> <branch>
.\.trellis\python.cmd .\.trellis\scripts\task.py set-base-branch <name> <branch>
.\.trellis\python.cmd .\.trellis\scripts\task.py set-scope <name> <scope>

# Hierarchy (parent/child)
.\.trellis\python.cmd .\.trellis\scripts\task.py add-subtask <parent> <child>
.\.trellis\python.cmd .\.trellis\scripts\task.py remove-subtask <parent> <child>

# PR creation
.\.trellis\python.cmd .\.trellis\scripts\task.py create-pr [name] [--dry-run]
```

> Run `.\.trellis\python.cmd .\.trellis\scripts\task.py --help` to see the authoritative list.
...
```bat
.\.trellis\python.cmd .\.trellis\scripts\add_session.py --title "Title" --commit "hash" --summary "Summary"
```

### Context Script

```bat
.\.trellis\python.cmd .\.trellis\scripts\get_context.py
.\.trellis\python.cmd .\.trellis\scripts\get_context.py --mode packages
.\.trellis\python.cmd .\.trellis\scripts\get_context.py --mode phase --step <X.Y>
```
